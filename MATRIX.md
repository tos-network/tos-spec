...
stage (76/76 conformance). The priority gaps are:
...
|--------------------|-----------|----------------|-----------------|-----------|--------------|---------------|------------|---------|------------|----------------|
| Core (transfer)    | 2v        | planned        | 1v              | planned   | n/a          | n/a           | n/a        | planned | planned    | planned        |
| Burn               | 1v        | planned        | planned         | planned   | n/a          | n/a           | n/a        | planned | n/a        | planned        |
| Multisig           | 1v        | planned        | planned         | planned   | n/a          | n/a           | n/a        | planned | n/a        | planned        |
| Energy / Freeze    | 2v        | planned        | 1v              | planned   | n/a          | n/a           | n/a        | planned | n/a        | planned        |
| Energy / Delegate  | 2v        | planned        | planned         | planned   | n/a          | n/a           | n/a        | planned | n/a        | planned        |
| Escrow             | 8v        | planned        | planned         | planned   | n/a          | n/a           | n/a        | planned | n/a        | planned        |
| Arbitration        | 10v       | planned        | planned         | planned   | n/a          | n/a           | n/a        | planned | n/a        | planned        |
| KYC                | 6v        | planned        | planned         | planned   | n/a          | n/a           | n/a        | planned | n/a        | planned        |
| Committee          | 3v        | planned        | planned         | planned   | n/a          | n/a           | n/a        | planned | n/a        | planned        |
| Contracts          | 2v        | planned        | planned         | planned   | planned      | n/a           | n/a        | planned | n/a        | planned        |
| Privacy (UNO)      | 2v        | planned        | planned         | planned   | n/a          | n/a           | n/a        | planned | n/a        | planned        |
| Privacy (shield)   | 1v        | planned        | planned         | planned   | n/a          | n/a           | n/a        | planned | n/a        | planned        |
| TNS (names)        | 1v        | planned        | planned         | planned   | n/a          | n/a           | n/a        | planned | n/a        | planned        |
| Referral           | 1v        | planned        | planned         | planned   | n/a          | n/a           | n/a        | planned | n/a        | planned        |
| Account / Agent    | 2v        | planned        | planned         | planned   | n/a          | n/a           | n/a        | planned | n/a        | planned        |
...
|--------------------|------------|------------|----------|----------|----------|----------|-------------|------------|
| Core (transfer)    | YES        | YES        | -        | -        | -        | -        | -           | -          |
| Burn               | YES        | YES        | -        | -        | -        | n/a      | -           | -          |
| Multisig           | YES        | YES        | -        | -        | -        | -        | -           | -          |
| Energy / Freeze    | YES        | YES        | YES      | -        | -        | -        | -           | -          |
| Energy / Delegate  | YES        | YES        | -        | -        | -        | YES      | -           | -          |
| Escrow             | YES        | YES        | -        | -        | -        | -        | -           | -          |
| Arbitration        | YES        | YES        | -        | -        | -        | -        | -           | -          |
| KYC                | YES        | YES        | -        | -        | YES      | -        | -           | -          |
| Committee          | YES        | -          | -        | -        | YES      | -        | -           | -          |
| Contracts          | YES        | YES        | -        | -        | -        | -        | -           | -          |
| Privacy (UNO)      | YES        | -          | -        | -        | -        | YES      | -           | -          |
| Privacy (shield)   | YES        | YES        | -        | -        | -        | -        | -           | -          |
| TNS (names)        | YES        | YES        | YES      | -        | -        | -        | -           | -          |
| Referral           | YES        | YES        | -        | -        | -        | YES      | -           | -          |
| Account / Agent    | YES        | -          | -        | -        | -        | -        | -           | -          |

**Reading this matrix:** Happy and error paths have broad coverage. The empty
columns (Boundary, Overflow, Fee Variant, Fork Param) represent systematic gaps
...
|---|---------------------------|----------------|-------|---------|-----------|------------|
| 1 | transfers                 | core           | 2     | 1       | 1         | 1          |
| 2 | burn                      | core           | 3     | 1       | 2         | 0          |
| 3 | multisig                  | account        | 3     | 1       | 2         | 0          |
| 4 | invoke_contract           | contracts      | 2     | 1       | 0         | 0          |
| 5 | deploy_contract           | contracts      | 2     | 1       | 1         | 0          |
| 6 | energy (freeze)           | energy         | 3     | 1       | 2         | 1          |
| 7 | energy (unfreeze)         | energy         | 3     | 1       | 2         | 0          |
| 8 | energy (delegate)         | energy         | 3     | 1       | 2         | 0          |
| 9 | energy (withdraw)         | energy         | 2     | 1       | 1         | 0          |
|10 | bind_referrer             | referral       | 3     | 1       | 2         | 0          |
|11 | batch_referral_reward     | referral       | 0     | 0       | 0         | 0          |
|12 | set_kyc                   | kyc            | 2     | 1       | 1         | 0          |
|13 | revoke_kyc                | kyc            | 1     | 1       | 0         | 0          |
|14 | renew_kyc                 | kyc            | 0     | 0       | 0         | 0          |
...
|21 | agent_account             | account        | 3     | 1       | 0         | 0          |
|22 | uno_transfers             | privacy        | 2     | 1       | 1         | 0          |
|23 | shield_transfers          | privacy        | 2     | 1       | 1         | 0          |
|24 | unshield_transfers        | privacy        | 1     | 1       | 0         | 0          |
|25 | register_name             | tns            | 4     | 1       | 3         | 0          |
|26 | ephemeral_message         | tns            | 0     | 0       | 0         | 0          |
|27 | create_escrow             | escrow         | 2     | 1       | 1         | 0          |
...
|35 | submit_verdict_by_juror   | escrow         | 0     | 0       | 0         | 0          |
...
|40 | register_arbiter          | arbitration    | 2     | 1       | 1         | 0          |
...
**Reading this matrix:** 3 types have zero tests (batch_referral_reward,
renew_kyc, ephemeral_message, submit_verdict_by_juror). Wire format coverage
is minimal (2/45). Most types have only 1 vector and 0 negative tests.
...
|-------------|-------|-------|---------|-----|------|----------|-------------|
| core        | 2     | 5     | 2       | 3   | 1    | 0        | 3/5         |
| energy      | 4     | 11    | 4       | 7   | 1    | 1        | 4/5         |
| escrow      | 9     | 9     | 8       | 1   | 0    | 0        | 2/5         |
| arbitration | 10    | 11    | 10      | 1   | 0    | 0        | 2/5         |
| kyc         | 8     | 9     | 8       | 1   | 0    | 0        | 2/5         |
| contracts   | 2     | 4     | 2       | 1   | 0    | 0        | 2/5         |
| privacy     | 3     | 5     | 3       | 2   | 0    | 0        | 2/5         |
| referral    | 2     | 3     | 1       | 2   | 0    | 0        | 2/5         |
| tns         | 2     | 4     | 1       | 3   | 0    | 1        | 3/5         |
| account     | 2     | 6     | 2       | 2   | 0    | 0        | 2/5         |
...
```
   ...
   KYC/Committee   | NONE | GOOD | NONE | NONE | NONE | NONE |
                   +------+------+------+------+------+------+
   Contracts       | NONE | OK   | NONE | NONE | NONE | NONE |
                   +------+------+------+------+------+------+
   Privacy         | NONE | OK   | NONE | NONE | NONE | NONE |
                   +------+------+------+------+------+------+
   TNS/Referral    | NONE | OK   | NONE | NONE | NONE | NONE |
                   +------+------+------+------+------+------+
   Account/Agent   | NONE | OK   | NONE | NONE | NONE | NONE |
                   +------+------+------+------+------+------+
...
Legend:  GOOD = broad coverage with success + error paths
